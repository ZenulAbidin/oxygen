...
- Install backend CLI tooling with `make require-deps`; the Makefile bootstraps `golangci-lint v1.53.3` with `GOTOOLCHAIN=go1.20.14` so newer hosts still match CI.
